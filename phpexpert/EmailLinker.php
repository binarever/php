...
__JS__;
		...
		private function emailReplaceCallback($matches){
			...
			return '<a href="?mail='.urlencode($encoded).' " '.' onclick="mailDecode(\" '.$encoded.'\');return false;">'.'email'.$matches['user'].'</a>';
		}
...
__REGEX__;
			return preg_replace_callback($emailRegex, array($this,'emailReplaceCallback'), $text);
		}
	};
?>