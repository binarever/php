...
*tasks as nested list,as applicable
...
EOT;
		...
		echo '<li>'; //Complete the ordered list
	}//End of foreach loop
...
if (($_SERVER['REQUEST_METHOD']=='POST')&&
	...
	if(mysql_affected_rows($dbc)==count($_POST['tasks'])){
...
//Retrieve all the uncomplete tasks:
...
<form action="viewtasks2.php" method="post">
EOT;
